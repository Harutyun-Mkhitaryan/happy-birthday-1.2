...
//     // Активируем аутро при достижении 95% страницы
...
// // Сбрасываем скролл при загрузке страницы
// window.onload = function() {
// 	window.scrollTo(0, 0);
// };

// // Отключаем восстановление позиции скролла в браузере
// if (history.scrollRestoration) {
// 	history.scrollRestoration = 'manual';
// }

// // Дополнительно: сброс скролла при обновлении страницы
...
window.onscroll = function() {
	if (isOutroActive) return; // Блокировать 3D-скролл при активном аутро
